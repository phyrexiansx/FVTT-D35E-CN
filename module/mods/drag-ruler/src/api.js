...
function setupProvider(speedProvider) {
	...
	game.settings.settings.get("D35E.speedProvider").default = getDefaultSpeedProvider();
	updateSpeedProvider();
}
...
export function updateSpeedProvider() {
	...
	currentSpeedProvider =
		...
		availableSpeedProviders[game.settings.settings.get("D35E.speedProvider").default];
}
