...
export class EditStats extends FormApplication {
    constructor(object, options = {}) {
        let stats = object?.getFlag("D35E", 'stats') || MonksTokenBar.stats;
    ...
    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
            ...
            title: 'Edit Stats',
            template: "./systems/D35E/module/monks-tokenbar/templates/editstats.html",
            width: 600,
            closeOnSubmit: true,
            resizable: true,
            popOut: true,
    ...
    _updateObject() {
        if (Object.keys(this.object).length != 0) {
            this.object.setFlag("D35E", 'stats', this.stats);
        }else
    ...
    resetStats() {
        if (Object.keys(this.object).length != 0) {
            ...
            this.object.unsetFlag("D35E", 'stats');
            this.close();
        }
        else
