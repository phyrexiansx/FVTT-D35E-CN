...
export class AssignXPApp extends Application {
    ...
    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
            ...
            template: "./systems/D35E/module/monks-tokenbar/templates/assignxp.html",
    ...
    */
    ...
    async assign() {
        ...
        if (chatactors.length > 0) {
            ...
            const html = await renderTemplate("./systems/D35E/module/monks-tokenbar/templates/assignxpchatmsg.html", requestdata);
...
export class AssignXP {
    ...
    static async onAssignXP(actorid, message, e) {
        if (game.user.isGM) {
            ...
            await message.setFlag("D35E", 'actors', actors);
        } else {
