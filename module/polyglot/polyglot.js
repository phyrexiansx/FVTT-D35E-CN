// [D35E]安全读取旧版 polyglot scope flag（模块未启用时 getFlag 会抛错，这里吞掉）
function _polyglotFlag(doc, key) { try { return doc.getFlag("polyglot", key); } catch (e) { return undefined; } }
...
function getFonts() {
	...
	return {
		"Ar Ciela": {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/ArCiela.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Aztec: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Aztec.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Barazhad: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Barazhad.otf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Celestial: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Celestial.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Daedra: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Daedra.otf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		"Dark Eldar": {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/DarkEldar.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Davek: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Davek.otf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Dethek: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Dethek.otf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		"Dragon Alphabet": {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/dragon_alphabet.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		"Elder Futhark": {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/ElderFutharkFS.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Eltharin: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Eltharin.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Espruar: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Espruar.otf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Floki: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Floki.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		"Finger Alphabet": {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/FingerAlphabet.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		"High Drowic": {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/HighDrowic.otf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		"Highschool Runes": {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/HighschoolRunes.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Infernal: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Infernal.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Iokharic: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Iokharic.otf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		"Jungle Slang": {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/JungleSlang.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Kargi: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Kargi.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		"Kremlin Premier": {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/KremlinPremier.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		"Mage Script": {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/MageScript.otf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		"Maras Eye": {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/MarasEye.otf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		"Meroitic Demotic": {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/MeroiticDemotic.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		"Miroslav Normal": {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/MiroslavNormal.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		MusiQwik: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/MusiQwik.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		"Ny Stormning": {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/NyStormning.otf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		"Olde English": {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/OldeEnglish.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		"Olde Espruar": {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/OldeEspruar.otf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		"Olde Thorass": {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/OldeThorass.otf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Ophidian: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Ophidian.otf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Pulsian: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Pulsian.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Oriental: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Oriental.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		"Ork Glyphs": {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/OrkGlyphs.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Qijomi: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Qijomi.otf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Reanaarian: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Reanaarian.otf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Rellanic: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Rellanic.otf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Saurian: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Saurian.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		"Scrapbook Chinese": {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/ScrapbookChinese.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Semphari: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Semphari.otf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Skaven: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Skaven.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Tengwar: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Tengwar.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Thassilonian: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Thassilonian.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Thorass: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Thorass.otf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Tuzluca: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Tuzluca.ttf"],
					weight: 400,
					style: "normal",
				},
			],
		...
		Valmaric: {
			...
			fonts: [
				{
					urls: ["systems/D35E/module/polyglot/fonts/Valmaric.ttf"],
					weight: 400,
					style: "normal",
				},
			],
...
class PolyglotFontSettings extends FormApplication {
	...
	static get defaultOptions() {
		...
		return mergeObject(super.defaultOptions, {
			...
			template: "./systems/D35E/module/polyglot/templates/FontSettings.hbs",
			classes,
			width: 780,
			height: 680,
			closeOnSubmit: true,
...
class PolyglotGeneralSettings extends FormApplication {
	static get defaultOptions() {
		...
		return mergeObject(super.defaultOptions, {
			...
			template: "./systems/D35E/module/polyglot/templates/GeneralSettings.hbs",
			classes,
		...
		html.find("button").on("click", async (event) => {
			...
			if (dataset?.action === "reset") {
				...
				if (game.user.isGM) {
					...
					await Promise.all(
						keys.map(async (key) => {
							await game.user.unsetFlag("D35E", key);
						}),
					);
				}
				this.close();
	...
	async _updateObject(event, formData) {
		...
		for (let [k, v] of Object.entries(foundry.utils.flattenObject(formData))) {
			...
			let current = game.user.isGM ? game.settings.get(s.namespace, s.key) : game.user.getFlag("D35E", k);
			...
			if (game.user.isGM) {
				...
				await game.user.setFlag("D35E", k, v);
			}
		}
...
class PolyglotLanguageSettings extends FormApplication {
	...
	static get defaultOptions() {
		...
		return mergeObject(super.defaultOptions, {
			...
			template: "./systems/D35E/module/polyglot/templates/LanguageSettings.hbs",
			classes,
			width: 600,
			height: 680,
			closeOnSubmit: true,
...
class LanguageProvider {
	...
	getDefaultLanguage() {
		...
		const userDefault = game.user.getFlag("D35E", "defaultLanguage") || _polyglotFlag(game.user, "defaultLanguage") ;
					...
					update: {
						...
						callback: () => {
							const changed = messagesInCommon.map((m) => {
								return {
									_id: m._id,
									"flags.D35E.language": pf2eDefaultLanguage // [D35E]scope 统一为 D35E
								};
							});
...
class PolyglotAPI {
	...
	init() {
		...
		if (!systemsRegex.test(game.system.id)) {
			// [D35E]系统 id 大小写不敏感匹配（如 D35E → d35e）
			const _ciMatch = supportedSystems.split("|").find((s) => s.toLowerCase() === String(game.system.id).toLowerCase());
			providerString = _ciMatch || providerKeys[game.system.id] || "Generic";
		}
	...
	defaultProvider() {
		...
		const gameSystem = providerIds.find((key) => key.startsWith("system.") || key.includes(game.system.id) || key.toLowerCase().includes(String(game.system.id).toLowerCase())); // [D35E]大小写不敏感
...
class PolyglotHooks {
	...
	static renderChatLog(chatlog, html, data) {
		...
		const input = game.settings.get("polyglot", "displayCheckbox")
			...
			: "";
		// [D35E]语言选择器置于骰子列表下方、输入框上方（原插在 #chat-controls 之后会跑到骰子栏上方）；加去重防重复注入
		if (!html.find("#polyglot").length) {
			html.find("#chat-message").before(
	...
	static updateActor(actor, data, options, userId) {
		if (actor.hasPlayerOwner && actor.testUserPermission(game.user, "OWNER")) {
			const changed = game.polyglot.updateUserLanguages(game.polyglot.chatElement);
			if (changed) game.polyglot.updateChatMessages(); // [D35E]语言集实际变化才重渲染消息
		}
	}
	...
	static preCreateChatMessage(message, data, options, userId) {
		...
		if (
			...
			if (lang) {
				message.updateSource({ "flags.D35E.language": lang }); // [D35E]scope 统一为 D35E（原 polyglot 旧 scope 在 v11 下 getFlag 会因模块未启用抛异常）
			}
		}
	}
	...
	static async renderChatMessage(message, html, data) {
		const lang = message.getFlag("D35E", "language") || _polyglotFlag(message, "language");
		if (!lang) return;
...
// Main shim code
// [D35E]加载 select2（系统内置，无模块 scripts 自动加载）
(function () { if (typeof jQuery !== "undefined" && !jQuery.fn.select2) { const s = document.createElement("script"); s.src = "systems/D35E/module/polyglot/lib/select2/select2.min.js"; document.head.appendChild(s); } })();
Hooks.once("init", () => {
...
class Polyglot {
	constructor() {
		...
		// [D35E]字体懒加载优化：不再注册进 CONFIG.fontDefinitions（核心会全量预载全部 46 字体，占启动大头），
		// 由 polyglot.css 的 @font-face 按需懒加载（首屏启动省约 46 个请求 + 1.7MB）；乱码字体首次用到时才下载
	}
	...
	init() {
		...
		try { // [D35E]lib-wrapper 不可用时跳过气泡乱码（不阻塞模块加载）
			libWrapper.register(
				"polyglot",
				...
				async (wrapped, token, message, { cssClasses, requireVisible = false, pan = true, language = "" } = {}) => {
					...
					if (language) {
						...
						if (gameMessages?.type === CONST.CHAT_MESSAGE_TYPES.IC) {
							lang = gameMessages.getFlag("D35E", "language") || "";
	...
	updateChatMessagesDelayed() {
		this.refreshTimeout = null;
		const LIMIT = 30; // [D35E]卡顿修复：只重渲染最近 30 条（原 100 条全量重渲染）
		const messages = this.chatElement
			.find(".message")
			.slice(-LIMIT)
			.toArray()
			.map((m) => game.messages.get(m.dataset.messageId))
			.filter((m) => m && m.getFlag("D35E", "language")); // [D35E]只处理带语言标记的消息（无语言的 IC/系统消息不受语言影响，跳过）
		const queue = [...messages].reverse(); // 最新优先
		const step = () => {
			const m = queue.pop();
			if (!m) return;
			ui.chat.updateMessage(m);
			if (queue.length) requestAnimationFrame(step); // [D35E]逐帧分批渲染，避免一次渲染全部阻塞 UI
		};
	...
	updateUserLanguages(html) {
		if (game.polyglot.languageProvider.requiresReady && !game.ready) return false;
		[this.knownLanguages, this.literateLanguages] = this.getUserLanguages();
		const _prevKnown = this._knownLanguagesForCompare;
		this._knownLanguagesForCompare = new Set(this.knownLanguages);
		const changed = !_prevKnown || _prevKnown.size !== this.knownLanguages.size || [..._prevKnown].some((l) => !this.knownLanguages.has(l)); // [D35E]语言集是否实际变化
		...
		if (!game.polyglot.renderChatLog || !html) return changed; // [D35E]返回语言集变化标志（html 可空）
		let options = [];
		let ownedActors = [];
		if (game.user.isGM) {
			...
			if (!this._ownedActors) this._ownedActors = game.actors.filter((actor) => actor.hasPlayerOwner); // [D35E]缓存（createActor/deleteActor 时清除）
			ownedActors = this._ownedActors;
	...
	scrambleString(string, salt, lang) {
		// [D35E]卡顿修复：乱码结果缓存（相同 语言+盐值+文本 复用，聊天消息重渲染时不再重建随机数与逐字符替换）
		this._scrambleCache = this._scrambleCache || new Map();
		const _cacheKey = lang + "|" + salt + "|" + string;
		const _cached = this._scrambleCache.get(_cacheKey);
		...
		const _result = string.replace(regex, () => {
		...
		if (this._scrambleCache.size > 4096) this._scrambleCache.clear();
		this._scrambleCache.set(_cacheKey, _result);
		return _result;
	}
...
async function preloadTemplates() {
	const templatePaths = [
		"systems/D35E/module/polyglot/templates/partials/settings.hbs",
		"systems/D35E/module/polyglot/templates/FontSettings.hbs",
		"systems/D35E/module/polyglot/templates/GeneralSettings.hbs",
		"systems/D35E/module/polyglot/templates/LanguageSettings.hbs",
	];
...
Hooks.once("init", () => {
	CONFIG.TinyMCE.content_css.push("/systems/D35E/module/polyglot/styles/polyglot.css");
	registerSettings();
...
// [D35E]actor 增删时清除 GM 语言缓存
Hooks.on("createActor", () => (game.polyglot._ownedActors = null));
Hooks.on("deleteActor", () => (game.polyglot._ownedActors = null));
