export class ActorChangesHelper {
    ...
    static getChangeFlat(changeTarget, changeType, curData) {
        ...
        switch (changeTarget) {
            ...
            case "aooCount":
                return "system.attributes.maxAoO";
            case "reach":
                return "system.traits.reachBonus";
        ...
        } else if (changeTarget.match(/^slot\.([a-zA-Z]+)$/)) {
            const slotKey = RegExp.$1;
            return `system.slotCapacities.${slotKey}`;
        }
